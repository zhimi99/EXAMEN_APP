...
a persistence unit "ZhiminaicelaChristianSRIJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ZhiminaicelaChristianSRIJEE\pom.xml":
...
artifact ("ZhiminaicelaChristianSRIJEE.war") is already built. You can build

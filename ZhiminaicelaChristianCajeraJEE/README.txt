...
a persistence unit "ZhiminaicelaChristianCajeraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ZhiminaicelaChristianCajeraJEE\pom.xml":
...
artifact ("ZhiminaicelaChristianCajeraJEE.war") is already built. You can build

...
a persistence unit "ZhiminaicelaChristianOperadoraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ZhiminaicelaChristianOperadoraJEE\pom.xml":
...
artifact ("ZhiminaicelaChristianOperadoraJEE.war") is already built. You can build
